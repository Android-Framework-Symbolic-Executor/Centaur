...
public class JPF_java_lang_StringBuilder extends NativePeer {
	  ...
	  public static int append__Ljava_lang_String_2__Ljava_lang_StringBuilder_2 (MJIEnv env, int objref, int sref) {
		System.out.println("JPF_java_lang_StringBuilder_append -- MJI");
		ThreadInfo ti = env.getThreadInfo();
		ElementInfo ei = ti.getElementInfo(sref);
		if (ei == null) {
			String s = "null";	
			return appendString(env, objref, s);
		} else {
	  ...
	  @MJI
	  public static int append__Ljava_lang_Object_2__Ljava_lang_StringBuilder_2 (MJIEnv env, int objref, int sref) {
		System.out.println("JPF_java_lang_StringBuilder_append -object -- MJI");
		ThreadInfo ti = env.getThreadInfo();
		ElementInfo ei = ti.getElementInfo(sref);
		if (ei == null) {
			String s = "null";	
